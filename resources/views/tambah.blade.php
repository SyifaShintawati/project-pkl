    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('siswa.store')}}" method="post"> {{csrf_field()}} @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="asal" type="text" class="form-control{{ $errors->has('asal') ? ' is-invalid' : '' }}" name="asal" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="date" name="tgl" id="tgl" class="form-control" require>
                            </div>
                        </div>
